var $3PT7f$express = require("express");
var $3PT7f$nodehttp = require("node:http");
var $3PT7f$nodehttps = require("node:https");
var $3PT7f$nodepath = require("node:path");
var $3PT7f$nodecrypto = require("node:crypto");
var $3PT7f$nodeevents = require("node:events");
var $3PT7f$ws = require("ws");
var $3PT7f$cors = require("cors");
...
class $7a434f2b8c14dece$export$3ee29d34e33d9116 {
    ...
    generateClientId(generateClientId) {
        const generateId = generateClientId ? generateClientId : (0, $3PT7f$nodecrypto.randomUUID);
...
class $e9ffe6de55430dbc$export$f47674b57e51ee3b extends (0, $3PT7f$nodeevents.EventEmitter) {
    constructor({ server: server, realm: realm, config: config }){
        ...
        this.socketServer = config.createWebSocketServer ? config.createWebSocketServer(options) : new (0, $3PT7f$ws.WebSocketServer)(options);
...
var $20377580afc1f4e2$export$2e2bcd8739ae039 = ({ config: config, realm: realm })=>{
    const app = (0, ($parcel$interopDefault($3PT7f$express))).Router();
...
const $6519c7a56ba95525$export$bf71da7aebe9ddc1 = ({ config: config, realm: realm, corsOptions: corsOptions })=>{
    const app = (0, ($parcel$interopDefault($3PT7f$express))).Router();
    app.use((0, ($parcel$interopDefault($3PT7f$cors)))(corsOptions));
    app.get("/", (_, res)=>{
...
const $516a786dc008ff17$export$99152e8d49ca4e7d = ({ app: app, server: server, options: options })=>{
    ...
    const customConfig = {
        ...config,
        path: (0, ($parcel$interopDefault($3PT7f$nodepath))).posix.join(app.path(), options.path, "/")
    };
...
function $123f4982a51872b4$export$8c57434a18c696c9(server, options) {
    const app = (0, ($parcel$interopDefault($3PT7f$express)))();
    const newOptions = {
...
function $123f4982a51872b4$export$f99d31af51f48b1e(options = {}, callback) {
    ...
    if (ssl && Object.keys(ssl).length) {
        server = (0, ($parcel$interopDefault($3PT7f$nodehttps))).createServer(ssl, app);
        newOptions = restOptions;
    } else server = (0, ($parcel$interopDefault($3PT7f$nodehttp))).createServer(app);
